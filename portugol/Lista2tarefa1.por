...
*/
	...
	funcao inicio()
	{
		...
		escreva ("Qual o peso total de tomates em kg?" )
		leia (P)
		...
		escreva ("O valor total de tomates é " + P + "kg\n")
		escreva ("O valor total excedente é " + E + "kg\n")
		escreva ("A multa a se pagar é no valor de " + M + "reais\n")
